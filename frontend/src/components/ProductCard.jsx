...
export default function ProductCard({ product, isFavourite = false, onToggleFavourite, onHover }) {
  ...
  return (
    ...
    >
      {/* Step 8 Trace: console.log('ProductCard Render:', product.name, 'Price:', product.price) */}
      
      {/* Image Container */}
      <div className="relative aspect-square overflow-hidden bg-[#FBF5EE] flex-shrink-0">
        {!imgError ? (
          <img
      ...
      <div className="p-4 md:p-5 flex flex-col flex-grow">
        <h3 className="font-serif text-[1.1rem] font-semibold text-[#2C1810] mb-2 line-clamp-2 leading-snug min-h-[2.8rem]">
          {product.name}
        </h3>
