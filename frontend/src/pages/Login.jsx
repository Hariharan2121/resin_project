      ...
      <div className="right-panel" style={styles.rightPanel}>
        <div className="card" style={{
          ...
          <div className="mobile-brand" style={{ display: 'none' }}>
            <img src="/images/icon.png" alt="RKL Logo" style={{ height: '48px', marginBottom: '8px' }} />
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.5rem', fontWeight: 700, background: 'linear-gradient(135deg, #8B4513 0%, #C87941 50%, #D4956A 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>RKL Trove</h2>
          </div>
